...
if __name__ == '__main__':
    # sentencize_training_data('ner_he_input', 'ner_he_input_broken', 24500, 2500, 'claude')
    sentencize_training_data('ner_en_input', 'ner_en_input_broken', 50000, 7500, 'claude')
