...
PIPELINE_PRESETS = {
    "sanity_check": {
        ...
        "LLM_CACHE_PATH": BASE_DIR / "output" / "cache" / "llm_cache_sanity_check.sqlite",
    ...
    "default": {
        ...
        "CONTEXT_EXPANSION_ANTHROPIC_MODEL": os.getenv("ANTHROPIC_CONTEXT_MODEL", os.getenv("ANTHROPIC_MODEL", "claude-sonnet-4-6")),
        "LLM_CACHE_ENABLED": True,
        "LLM_CACHE_PATH": BASE_DIR / "output" / "cache" / "llm_cache.sqlite",
        "LLM_CACHE_FLUSH_BEFORE_RUN": False,
        "QUERIES_PER_TYPE_PER_DOC": 3,
        "QUERY_TYPES_PER_DOC": 2,
        "QUERY_TYPE_SAMPLE_SEED": 613,
...
LLM_CACHE_FLUSH_BEFORE_RUN = CONFIG["LLM_CACHE_FLUSH_BEFORE_RUN"]
...
def configure_eval_generator() -> None:
    ...
    eval_gen.LLM_CACHE_ENABLED = LLM_CACHE_ENABLED
    eval_gen.LLM_CACHE_PATH = LLM_CACHE_PATH
    eval_gen.LLM_CACHE_FLUSH_BEFORE_RUN = LLM_CACHE_FLUSH_BEFORE_RUN
...
def generate_dataset(sampled_refs: list[dict]) -> None:
    ...
    if LLM_CACHE_FLUSH_BEFORE_RUN:
        eval_gen.flush_llm_cache()
